...
public class ConnectedFriendsResponseBody extends PayloadBody {
    private List<User> users;

    public ConnectedFriendsResponseBody() {
    }

    public ConnectedFriendsResponseBody(List<User> users) {
        this.users = users;
    }
    ...
    public PayloadBody fromJSON(JSONObject jsonObj) {
        ...
        return new ConnectedFriendsResponseBody(userList);
    }
